...
Some components require that the translations are generated properly. In some cases this is the only way to pass the automated tests. For example for the script component, run the following:
```shell
